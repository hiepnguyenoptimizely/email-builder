...
#### User behaviors
There're two target users in this investigation.
###### Customer
> 1. Run ads for campaigns on: Facebook, Twitter, Google, Linkedin, ... and ads post links audience to regarding landing page
> 2. Create email template for email ads campaigns	
###### Developer
> 1. Design and get code quickly, then customizes it.
> 2. Present a new features for client
#### Problems
---
> 1. Design and get html code with no code
> 2. Deploy quickly
#### Solution
---
[GrapesJS](http://grapesjs.com) has good drag-n-drop features, export HTML and totally free.
...
3. With Velocity engine in Java
4. With Tailwindcss

You can try them on folders in this repo.